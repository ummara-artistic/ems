...
def generate_salary(request, employee_id, year, month):
    ...
    if request.method == 'POST':
        ...
        filename = f"salary_slip_{employee.name}_{employee.last_name}_{month}_{year}.pdf".replace(" ", "_")
...
def generate_pdf(request, pk):
    ...
    try:
        ...
        filename = f"salary_slip_{salary_record.employee.name}_{salary_record.employee.last_name}_{salary_record.month}_{salary_record.year}.docx".replace(" ", "_")
